...
$H_0:$ There is not a correlation between recieving the vaccine and contracting the AIDS Virus

$H_A:$ There is a correlation between recieving the vaccine and contracting the AIDS Virus
...
The barchart above shows there is no significant difference in the group who did not contract the virus. However, in the group who contracted the AIDS virus, there is a significant difference bewteen who recieved the placebo and vacine. These results imply that the vaccine helped recude the occurance of the AIDS virus.  
...
The vaccine made a difference because, in the first group, 99.38 people did not get it and, in the second group the vaccine does not matter because only 50% of vaccinated subjects were able to escape the virus. In the second group half of the people with the placebo got AIDS, so the vaccine does not work.
...
In the Chi-Dquare test the P-Value is at 0.0482 therefore we can accept the null hypothesis as untrue. In the table above you can see the p-value 0.0482 of the shaded area under the curve. The null hypothesis is there is not a correlation between recieving the vaccine and contracting the AIDS Virus.

## Conclusions

<Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom>
<Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom><Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom>

In this study, the data collected was used to test the effectiveness of the vaccine agaisnt the AIDS virus. We came up with two hypothesis, graphed them, and put the data in a chi squared test. In the graph we saw that people who were vaccinated were not getting the virus as much as the poeple who recieved the placebo. In the chi suqared test out p-value for the data is at 0.0482 therefore we can accept the null hypothesis as untrue. By rejecting the null, the alternative is true meaning that there is a correlation between recieving the vaccine and contracting the AIDS Virus.
